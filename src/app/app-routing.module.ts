...
const routes: Routes = [
  ...
  // },
  {
    ...
    children: [
      { path: 'salles', loadChildren: () => import('./modules/salle/salle.module').then(m => m.SalleModule) },
      { path: 'reservations', loadChildren: () => import('./modules/reservation/reservations.module').then(m => m.ReservationsModule) },
      {
        path: 'widgets',
        loadChildren: () =>
